...
class CombineTests: XCTestCase {
    ...
    @MainActor func testPublisherSuccess() {
        ...
        let mockRoute = Mock.ResponseRoute(serializer: Mock.Response.Serializer(.success("mock_response")))
    ...
    @MainActor func testPublisherFailure() {
        ...
        let mockRoute = Mock.ResponseRoute(serializer: Mock.Response.Serializer<Void>(.failure(mockError)))
        mockRoute.publisher.sink { completion in
            XCTAssertEqual(completion, .finished)
            expectation.fulfill()
        } receiveValue: { result in
    ...
    @MainActor func testPublisherCancellation() {
        ...
        let mockRoute = Mock.ResponseRoute(session: NetworkingSession(urlSession: URLSession(configuration: .default)),
                                   serializer: Mock.Response.Serializer(.success("mock_response")))

...
///
/// - Note: An example of a NetworkingResponseSerializer is ``NetworkingSerializers/Response/Decodable``. See more `NetworkingResponseSerializer`'s under ``NetworkingSerializers/Response``.
